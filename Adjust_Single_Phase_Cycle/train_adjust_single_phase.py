...
-> python train_adjust_single_phase.py --delta_time 20 --num_envs 20
@LastEditTime: 2024-06-27 23:31:11
'''
import os
import torch
import argparse
...
def train_model(env, delta_time, tensorboard_path, callback_list):
    ...
    model.learn(total_timesteps=3e5, tb_log_name=f'Adjust_Single_Phase_{delta_time}', callback=callback_list)
    return model
