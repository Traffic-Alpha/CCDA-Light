'''
@Author: WANG Maonan
@Date: 2022-10-17 15:30:47
@Description: 测试 Next or Not 的动作, 输入参数的版本
@LastEditTime: 2022-10-31 15:35:41
'''
import os
import shutil
import torch
...
if __name__ == '__main__':
    ...
    # 路网参数
    parser = argparse.ArgumentParser("Run Next or Not experiments.")
    ...
    MODEL_TYPE = args.model_type # 测试模型的名称, last or best
