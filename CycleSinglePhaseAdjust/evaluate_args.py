'''
@Author: WANG Maonan
@Date: 2022-10-10 14:32:52
@Description: 测试 Single Cycle Adjustment 的结果, 在原有测试的基础上, 将所有的内容参数化
@LastEditTime: 2022-10-24 15:54:51
'''
import os
import shutil
import itertools
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_type", required=True, help="测试的模型名称, 这里可以选择 best or last.")
    parser.add_argument("--route_id", required=True, help="路网的名称.")
    ...
    MODEL_TYPE = args.model_type # 测试模型的名称
    route_id = args.route_id # route 的名称
