...
- nohup srun -J CycleSinglePhaseAdjust -p CPU -n 1 -c 30 -w st-node-157 python train.py > node_157.log &
@LastEditTime: 2022-08-22 21:56:34
'''
import os
import argparse
...
if __name__ == '__main__':
    ...
    DURATION_RANGE = [
        [-5, 5] for _ in range(int(net_id[0])) # net_id=6phases, 第一个数字表明路网有多少相位
    ] # 每个 phase 变化范围
