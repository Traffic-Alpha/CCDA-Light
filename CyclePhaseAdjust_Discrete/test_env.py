...
@Description: 一个周期对相位进行调整
@LastEditTime: 2022-10-08 11:07:40
'''
import os
import numpy as np
...
if __name__ == '__main__':
    ...
    tls_id = 'htddj_gsndj'
    sumo_cfg = pathConvert(f'../nets/fourWay/env/single_junction.sumocfg')
    net_file = pathConvert(f'../nets/fourWay/env/4phases.net.xml')
    route_list = [pathConvert('../nets/fourWay/routes/stable.rou.xml')]
